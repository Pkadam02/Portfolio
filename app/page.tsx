...
export default function Home() {
  return (
    <div className="w-full flex flex-col relative z-10 overflow-hidden bg-transparent">
      ...
      {/* 2. From Draft To Production Step Sequence
      <ProcessSequence /> */}

      {/* 3. Biography & Timeline */}
      <About />

      {/* 4. Three Pillars & Orbit Tech Directory */}
      <Skills />

      {/* 5. Process Methodology (01 DRAFT, 02 CODE, 03 SCALE) */}
      <Methodology />

      {/* 6. Capabilities & Workshop Services */}
      <Services />

      {/* 7. Selected Works & Case Study Mockups */}
      <Projects />
